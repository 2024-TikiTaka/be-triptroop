...
public class ScheduleController {
    ...
    public ResponseEntity<ApiResponse<ScheduleDetailResponse>> findByScheduleId(@PathVariable(name = "scheduleId") final Long scheduleId) {
        ...
        final ScheduleDetailResponse scheduleDetailResponse = scheduleService.findByScheduleId(scheduleId);
    ...
    public ResponseEntity<ApiResponse> removeItem(
        ...
        return ResponseEntity.status(HttpStatus.NO_CONTENT)
                             .body(ApiResponse.success("일정 계획이 삭제 되었습니다."));

    }

    // 일정 신청자 리스트 조회
    @GetMapping("{scheduleId}/schedulesParticipantList")
    public ResponseEntity<ApiResponse<List<ScheduleParticipantProfileResponse>>> findAllSchedulesParticipant(@PathVariable final Long scheduleId) {
